...
// Define project data
const projectsData = [
    { id: 'scripture-names', name: 'Scripture Names', description: 'An interactive list of approximately 3,000 names found in the Holy Bible, along with their meanings and origins.', externalLink: 'https://scripturenames.netlify.app/' }, // MODIFIED: Direct link to your Netlify site
