...
// Define project data
const projectsData = [
    { id: 'scripture-names', name: 'Scripture Names', description: 'An interactive list of names found in the Holy Bible, with meanings and origins.', externalLink: 'https://namescriptures.netlify.app/' }, // Modified to link to external index.html
